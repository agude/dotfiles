...
# Start blinking
export LESS_TERMCAP_mb=$(tput bold; tput ${TEXT} ${RED})
# Start bold mode
export LESS_TERMCAP_md=$(tput bold; tput ${TEXT} ${BLUE})
# Start half bright mode
export LESS_TERMCAP_mh=$(tput dim)
# Start reverse mode
export LESS_TERMCAP_mr=$(tput rev)
# Start standout mode
export LESS_TERMCAP_so=$(tput ${BG} ${WHITE}; tput ${TEXT} ${BLACK})
# End standout mode
export LESS_TERMCAP_se=$(tput rmso; tput sgr0)
# Start underlining
export LESS_TERMCAP_us=$(tput smul; tput bold; tput ${TEXT} ${MAGENTA})
# End underlining
