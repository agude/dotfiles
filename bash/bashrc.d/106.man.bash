...
export LESS_TERMCAP_mb=$(tput bold; tput ${_text} ${_red})              # Start blinking
export LESS_TERMCAP_md=$(tput bold; tput ${_text} ${_blue})             # Start bold mode
export LESS_TERMCAP_mh=$(tput dim)                                      # Start half bright mode
export LESS_TERMCAP_mr=$(tput rev)                                      # Start reverse mode
export LESS_TERMCAP_so=$(tput ${_bg} ${_white}; tput ${_text} ${_black}) # Start standout mode
export LESS_TERMCAP_se=$(tput rmso; tput sgr0)                          # End standout mode
export LESS_TERMCAP_us=$(tput smul; tput bold; tput ${_text} ${_magenta}) # Start underlining
